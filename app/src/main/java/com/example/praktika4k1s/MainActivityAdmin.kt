...
import kotlinx.android.synthetic.main.activity_cabinet.btnSearch
import kotlinx.android.synthetic.main.activity_cabinet.editSearch
import kotlinx.android.synthetic.main.activity_cabinet.recyclerView
...
class MainActivityAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnAddCabinet.setOnClickListener {
            val intent = Intent(this@MainActivityAdmin, AddCabinetActivityAdmin::class.java)
            ...
            call.enqueue(object : Callback<List<ModelClassCabinetList>> {
                override fun onResponse(call: Call<List<ModelClassCabinetList>>, response: Response<List<ModelClassCabinetList>>) {
                    if (response.code() == 200) {
                        ...
                        recyclerView.adapter = AdminRecyclerAdapter(response.body()!!, this@MainActivityAdmin)
                    }
                }
